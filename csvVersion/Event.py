...
class Event(object):
    ...
    def toString(self):
        return "\"%s\"" % self.subject + "," + "\"%s\"" % time.strftime("%m/%d/%Y", self.startdate) + "," + "\"%s\"" % time.strftime("%I:%M:%S %p", self.starttime) + "," + "\"%s\"" % time.strftime("%m/%d/%Y", self.enddate) + "," + "\"%s\"" % time.strftime("%I:%M:%S %p", self.endtime) + "," + "\"%s\"" % self.alldayevent + "," + "\"%s\"" % self.remon + "," + "\"%s\"" % self.remdate + "," + "\"%s\"" % self.remtime + "," + "\"%s\"" % self.meetorg + "," + "\"%s\"" % self.reqatt + "," + "\"%s\"" % self.optatt + "," + "\"%s\"" % self.meetres + "," + "\"%s\"" % self.billinfo + "," + "\"%s\"" % self.categor + "," + '\"%s\"' % self.description + "," + "\"%s\"" % self.location + "," + "\"%s\"" % self.mileage + "," + "\"%s\"" % self.priority + "," + "\"%s\"" % self.private + "," + "\"%s\"" % self.sensitivity + "," + "\"%s\"" % self.showtimeas